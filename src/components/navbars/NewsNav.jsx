      ...
      <nav className="bg-white fixed top-0 z-50 left-0 right-0 transition: all 300ms ease-in-out shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Home Icon */}
            <Link to="/" className="flex items-center cursor-pointer text-slate-600 hover:bg-[#329898]  hover:text-white px-3 py-2 rounded-md">
            ...
            <div className="hidden md:block">
              <div className="ml-4 md:ml-10 flex items-center space-x-4">
                <Link
                  to='/harari-news'
                  className="text-slate-600 hover:bg-[#329898] hover:text-white px-3 py-2 rounded-md text-lg font-medium"
                >
                  Harari News
                </Link>
                <Link
