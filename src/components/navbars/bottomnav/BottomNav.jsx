...
const BottomNavbar = () => {
        ...
        <ul className="flex items-center">
          ...
          <div className="hidden lg:block">
            <ul className="flex items-center space-x-2">
                  ...
                  <a className="inline-flex w-full cursor-pointer justify-center gap-x-0 bg-white px-3 py-2 text-sm text-[#1e293b] hover:text-[#3bb5b5]" id="menu-button" aria-expanded="true" aria-haspopup="true">
                    Home
          ...
          <li className="group z-10 relative dropdown   text-gray-600 hover:text-orange-600 cursor-pointer text-md font-serif ">
            <a className="hover:text-[#3bb5b5] inline-flex w-full justify-center gap-x-0  bg-white px-3 py-2 text-sm text-[#1e293b]" id="menu-button" aria-expanded="true" aria-haspopup="true">Timely
              <svg className="-mr-1 h-4 w-4  text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
              </svg>
            </a>
  ...
  <li className="group z-10 relative dropdown   text-white  hover:text-orange-600 cursor-pointer text-md font-serif ">
