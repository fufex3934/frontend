...
function BottomImages() {
  return (
    <div className='flex flex-col justify-between items-center px-4 md:flex-row md:justify-between md:items-center md:px-20 mb-10 pb-14 mt-[180vh] md:mt-[25vh] lg:mt-24'>
      ...
      <img className='mb-4 w-16 h-16' src="/images/about_logo_4.png" alt="about4" />
    </div>
  );
}
