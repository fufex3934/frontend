...
const Explore = () => {
    return (
        <>
            <div className='block m-5  p-5'>

                <div className='inline w-full'>
                    <div className="block text-center ">
                        <h3 className="text-2xl  font-bold text-slate-600 font-sans">
                    ...
                    <div className="mt-4 text-center ">
                        <button className="bg-black text-xl  font-serif hover:bg-orange-700 text-white font-bold py-2 px-4 -me-10 rounded">
                            Explore Service
                        </button>
                    </div>
                </div>
