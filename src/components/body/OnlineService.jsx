...
const OnlineService = () => {
  ...
  return (
    <div className="bg-[#08143c] h-80 w-screen">
      ...
      <div className="flex relative -top-44 bg-red-400 h-72 w-[120vh] float-right mr-12">
        {/* left div */}
        <div className="bg-white h-72 w-[60vh] py-10 px-8">
          <span
        ...
        {/* right div  */}
        <div className="bg-red-500 h-72 w-[60vh]"></div>
      </div>
    </div>
  );
};
