...
const OnlineService = () => {
  ...
  return (
    <div className="bg-[#08143c] h-auto  md:h-[50vh] lg:h-[70vh] w-full mt-2 mb-[50vh] drop-shadow-2xl">
       ...
       <div className="flex flex-col  md:flex-row  lg:mx-auto relative lg:-top-48 sm:h-80  sm:w-[120vh] lg:-mr-28 ">
                {/* left div */}
                <div className="bg-white sm:h-80 lg:h-[70vh] sm:w-[60vh] md:w-[45vh] py-6 sm:py-10 px-6 sm:px-8 ">
                <span
              ...
              >
                ...
                <span className={`ml-[105px] icon-transition ${leftHoveredIndex === 5 ? 'animate-icon' : ''}`}>{renderLeftIcon(5)}</span>
                  ...
                  {/* Add more spans for other items */}
                </div>
                {/* right div  */}
                <div className="bg-[#3bb5b5]  sm:h-80 lg:h-[70vh] sm:w-[60vh] md:w-[45vh] py-6 sm:py-10 px-4">
                <span
