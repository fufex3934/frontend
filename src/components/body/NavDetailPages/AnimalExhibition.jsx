  ...
  return (
    <>
      ...
      <div className=' mx-5 bg-slate-50 my-5'>
        <div className=" max-w-[1240px] border-emerald-950 mx-auto  bg-slate-50  grid md:grid-cols-1 lg:grid-cols-3 py-5 gap-8 mt-10 rounded-2xl">
          <div className="w-full shadow-xl flex flex-col py-4 my-4 rounded-full hover:scale-105 duration-300">
            ...
            <div className="font-medium text-center">
              <span className="py-2 border-b mx-6 "> {t('animal.p3')}  </span>
              <p className="py-2 border-b mx-6 ">{t('animal.p4')} </p>
              <span className="py-2 border-b mx-6 ">{t('animal.p5')}</span>
            </div>
