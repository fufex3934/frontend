                      ...
                      <div className="bg-white rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition duration-300">
                        <div className="relative overflow-hidden">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                            <p className="text-white text-sm flex items-center justify-center">
                              ...
                              {formatDistanceToNow(new Date(homeNews[index].time), {
                                addSuffix: true,
                              })}
                            </p>
                          </div>
                        ...
                        <div className="p-6 ">
                          ...
                          <div className="flex items-center justify-between ">
                            <p className="text-sm text-[#141414] font-semibold italic">
                              {homeNews[index].category}
                            </p>
                            <button>
                              <Link
                                to={`/news/${homeNews[index].slug.current}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="flex items-center justify-between">
            <p className="text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} Harar Government Communication Affairs Office.
              All rights reserved.
            </p>
