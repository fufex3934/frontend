...
const monuments_data = [
  ...
  { id: 3, name: 'The Harari Cultural House (Gey Gar)  Over a milinium since the Harari people used to construct their own houses using the porous stone (hashi un) and mud. This house is a three simple room type; the main front part, the interior and the stair. The roof of the house is covered with the properly sequenced timber', image: 'm8.jpeg', icons: { icon1: <FcLike/>, icon2: <IoIosHeartDislike />  } },
