...
const monuments_data = [
  ...
  { id: 3, name: 'B', p: 'Ratione explicabo nam odit doloribus rem molestiae, maiores corrupti aperiam nesciunt ex adipisci, illum autem voluptatem ipsa. Numquam unde odit repudiandae nisi.', image: 'm3.jpg', icons: { icon1: <FcLike/>, icon2: <IoIosHeartDislike />  } },
  { id: 4, name: 'B', p: 'Ratione explicabo nam odit doloribus rem molestiae, maiores corrupti aperiam nesciunt ex adipisci, illum autem voluptatem ipsa. Numquam unde odit repudiandae nisi.', image: 'm4.jpeg', icons: { icon1: <FcLike />, icon2: <IoIosHeartDislike />  } },
  { id: 5, name: 'B', p: 'Ratione explicabo nam odit doloribus rem molestiae, maiores corrupti aperiam nesciunt ex adipisci, illum autem voluptatem ipsa. Numquam unde odit repudiandae nisi.', image: 'm5.jpeg', icons: { icon1: <FcLike />, icon2: <IoIosHeartDislike />  } },
  ...
  { id: 7, name: 'C', p: 'Ratione explicabo nam odit doloribus rem molestiae, maiores corrupti aperiam nesciunt ex adipisci, illum autem voluptatem ipsa. Numquam unde odit repudiandae nisi.', image: 'm7.jpg', icons: { icon1: <FcLike />, icon2: <IoIosHeartDislike />  } },
  { id: 8, name: 'D', p: 'Ratione explicabo nam odit doloribus rem molestiae, maiores corrupti aperiam nesciunt ex adipisci, illum autem voluptatem ipsa. Numquam unde odit repudiandae nisi.', image: 'm8.jpeg', icons: { icon1: <FcLike />, icon2: <IoIosHeartDislike /> } }
];
const Monuments = () => {
  useEffect(() => {
