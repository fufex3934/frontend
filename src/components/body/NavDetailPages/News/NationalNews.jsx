  ...
  return (
    <>
      ...
      {/* Home News section */}
      {
        ...
        <div className=" absolute max-w-7xl  px-4 sm:px-6 lg:px-8 top-4 md:top-24 container mx-auto">
                ...
                return (
                  <animated.div key={slug.current} style={props}>
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <button>
                      <Link to={`/news/${nationalNews[index].slug.current}`}  className="relative inline-block text-lg group">
