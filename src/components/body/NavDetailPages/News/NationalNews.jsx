      ...
      {loading ? (
        <div className="flex items-center justify-center h-screen">
          <div className="animate-spin rounded-full h-10 w-10 border-t-2 
           border-b-2 border-[#329898] transition-all duration-700"></div>
        </div>
      ) : (
                  ...
                  <animated.div key={slug.current} style={props}>
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <Link to={`/news/${slug.current}`}>
                        <img className="w-full h-48 object-cover" src={image.asset.url} alt={image.alt} />
                      </Link>
                      <div className="p-4">
                        <Link
                        ...
                        <div className="flex items-center space-x-16">
                          ...
                          <button>
                            <Link
                              to={`/news/${nationalNews[index].slug.current}`}
