...
function NationalNews() {
  ...
  return (
    <>
        ...
        <div className=" absolute max-w-7xl  px-4 sm:px-6 lg:px-8 top-24 md:top-24 container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 ">
              {trail.map((props, index) => {
                const { title, slug, image, description, time, category } = nationalNews[index];
                ...
                return (
                  <animated.div key={slug.current} style={props}>
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <button>
                      <Link to={`/news/${nationalNews[index].slug.current}`} className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
     ...
     {/* footer part */}
     <footer className="bg-[#132244] py-24  mt-[730vh] md:mt-[200vh] lg:mt-[240vh] ">
